...
utils_Folder = os.environ["utilsFolder"]
print(utils_Folder)
...
inputFolder = os.environ["PathToRaw"]
outputFolder = os.environ["PathToSave"]
...
INTERP_DIR = outputFolder+'/interpolated'
OUTPUT_IMAGE_DIR = outputFolder+'/image_crop'
OUTPUT_MASK_DIR = outputFolder+'/label_crop'
...
'''
INTERP_DIR = INTERP_DIR# + ''.join(str(img_spacing)) # Directory to save interpolated nrrds;

OUTPUT_IMAGE_DIR = OUTPUT_IMAGE_DIR + ''.join(str(img_spacing))
OUTPUT_MASK_DIR = OUTPUT_MASK_DIR + ''.join(str(img_spacing))
