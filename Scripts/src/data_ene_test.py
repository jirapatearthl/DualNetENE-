...
cwd = os.getcwd()
cwd_before = os.path.dirname(cwd)
sys.path.append(cwd_before+'/utils')
...
def get_data(mode, model_input_size, MULTI_PREDICTION, image_format, SAVE_CSV, min, max, Path_In, Path_Out):
    
    SPACING = (1,1,3) #"" 
    print("SPACING: ", SPACING)
    
    PATH_image = Path_In ###+ str(SPACING)
    PATH_mask = Path_In ###+ str(SPACING)
